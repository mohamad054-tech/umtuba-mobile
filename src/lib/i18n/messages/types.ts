...
export type MobileMessages = {
  ...
  "edit.saved": string;
  "edit.failed": string;
  "edit.livePreserved": string;
  "edit.loadFailed": string;
  "edit.caption": string;
  "edit.hashtags": string;
  "edit.hashtagsPlaceholder": string;
  "edit.articleTitle": string;
  "edit.articleBody": string;
  "edit.removeArticle": string;
  "edit.replaceVideo": string;
  "edit.cover": string;
  "edit.clearCover": string;
  "edit.trim": string;
  "edit.trimIn": string;
  "edit.trimOut": string;
  "edit.preview": string;
  ...
  "profile.openFollowers": string;
  "profile.openFollowing": string;
  "profile.followersEmpty": string;
  "profile.followingEmpty": string;
  "profile.followersFailed": string;
