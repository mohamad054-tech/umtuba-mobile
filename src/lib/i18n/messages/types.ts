...
export type MobileMessages = {
  ...
  "create.editorDiscardPublishedBody": string;
  "create.editorKeep": string;
  "create.trim": string;
  "create.trimStart": string;
  "create.trimEnd": string;
  "create.trimDuration": string;
  "create.split": string;
  "create.deleteSegment": string;
  "create.undo": string;
