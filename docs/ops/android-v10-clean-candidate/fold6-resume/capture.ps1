# Fold6 v10 resume QA capture. Do not write to Desktop.
$ErrorActionPreference = "Continue"
$Out = "C:\Users\1\Desktop\umtuba\worktrees\DESKTOP-ANDROID-V9-LOC\docs\ops\android-v10-clean-candidate\fold6-resume"
$Serial = "RFCX718LVHK"
...
function Capture-Qa([string]$Name) {
  ...
  $txt = Join-Path $Out "$Name-texts.txt"
  $nodes = Join-Path $Out "$Name-nodes.txt"
