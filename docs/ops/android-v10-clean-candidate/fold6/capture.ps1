# Fold6 v10 clean-candidate QA capture helper. Do not write to Desktop.
$ErrorActionPreference = "Continue"
$Out = "C:\Users\1\Desktop\umtuba\worktrees\DESKTOP-ANDROID-V9-LOC\docs\ops\android-v10-clean-candidate\fold6"
$Serial = "RFCX718LVHK"
